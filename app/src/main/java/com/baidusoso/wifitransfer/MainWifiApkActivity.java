...
public class MainWifiApkActivity extends AppCompatActivity implements Animator.AnimatorListener {
    Unbinder mUnbinder;
            ...
            switch (item.getItemId()) {
                case R.id.test_menu1:
                    if (!mApps.isEmpty()) {
                        ...
                        Toast.makeText(MainWifiApkActivity.this, "暂无可删内容", Toast.LENGTH_SHORT).show();
                    }
                    break;
            }
            return false;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 1) {
                ...
                return new MyViewHolder(LayoutInflater.from(
                        MainWifiApkActivity.this).inflate(R.layout.layout_book_item, parent,
                        false));
            }
        }
...
//            holder.mTvAppInstall.setText(infoModel.getName());
                ...
                holder.mTvAppInstall.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        installApkFile(MainWifiApkActivity.this, new File(infoModel.getPath()));
                    }
                });
                holder.mTvAppDelete.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        delete(MainWifiApkActivity.this, infoModel.getPackageName());
                    }
                });
